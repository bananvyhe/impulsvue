...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { cover: @library.cover, desc: @library.desc, file: @library.file, name: @library.name } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { cover: @library.cover, desc: @library.desc, file: @library.file, name: @library.name } }
