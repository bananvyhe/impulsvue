...
class SlidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post sliders_url, params: { slider: { caption1: @slider.caption1, caption2: @slider.caption2, slide: @slider.slide } }
    end
  ...
  test "should update slider" do
    patch slider_url(@slider), params: { slider: { caption1: @slider.caption1, caption2: @slider.caption2, slide: @slider.slide } }
